...
function Payment() {
  ...
  const navigate = useNavigate();
   ...
   const handleChange = (e) => { // handle card error and change card element color when error occurs 
     console.log(e);
  ...
  const handlePayment = async (e) => {
    ...
    // step;  1. backend || functions ---> contact to the client secret ---> axios install adregen backendachenen contact enadergalen client secretachenen lemagegnet 
        ...
        <div className={classes.flex}>
          ...
          <div className={classes.payment__card__container}>
            <div className={classes.payment__details}>
              <form onSubmit={handlePayment}>// handle payment on form submit 
                {/* error */}
                {cardError && (
